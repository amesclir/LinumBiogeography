...
#library(devtools)
#devtools::install_github(repo="liamrevell/phytools") #Installing las version of phytools from Github

#devtools::install_github(repo="nmatzke/BioGeoBEARS") #Installing las version of BioGeoBEARS from Github
```
