...
# For a slow analysis, run once, then set runslow=FALSE to just 
# load the saved result.
resfn = "Linum_DEC+J_M0_constrained_w.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# PDF plots
#######################################################
pdffn = "Linum_DEC_vs_DEC+J_M0_constrained_w.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Linum M0_constrained"
...
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Linum M0_constrained"
...
runslow = TRUE
resfn = "Linum_DIVALIKE_M0_constrained_w.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Linum_DIVALIKE+J_M0_constrained_w.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Linum_DIVALIKE_vs_DIVALIKE+J_M0_constrained_w.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Linum M0_constrained"
...
# Plot ancestral states - DIVALIKE+J
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Linum M0_constrained"
...
geogfn = np("Linum_BGB_occurrence_world_bis.txt")
#extdata_dir = np(system.file("extdata", package="BioGeoBEARS"))
#extdata_dir
#list.files(extdata_dir)
#geogfn = np(paste(addslash(extdata_dir), "Psychotria_geog.data", sep=""))
...
# load the saved result.
runslow = TRUE
resfn = "Linum_DEC_M0_unconstrained_v2.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
# For a slow analysis, run once, then set runslow=FALSE to just 
# load the saved result.
resfn = "Linum_DEC+J_M0_unconstrained_v2.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# PDF plots
#######################################################
pdffn = "Linum_DEC_vs_DEC+J_M0_unconstrained_v2.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Linum M0_unconstrained_v2"
...
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Linum M0_unconstrained_v2"
...
runslow = TRUE
resfn = "Linum_DIVALIKE_M0_unconstrained_v2.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Linum_DIVALIKE+J_M0_unconstrained_v2.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Linum_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v2.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Linum M0_unconstrained_v2"
...
# Plot ancestral states - DIVALIKE+J
#######################################################
analysis_titletxt ="Linum DIVALIKE+J on Linum M0_unconstrained_v2"
...
# Uncomment files you wish to use in time-stratified analyses:
BioGeoBEARS_run_object$timesfn = "timeperiods.txt"
BioGeoBEARS_run_object$dispersal_multipliers_fn = "Linum_BGB_manual_dispersal_multipliers_bis.txt"
#BioGeoBEARS_run_object$areas_allowed_fn = "areas_allowed.txt"
#BioGeoBEARS_run_object$areas_adjacency_fn = areasadjacency
#BioGeoBEARS_run_object$distsfn = "distances_matrix.txt"
# See notes on the distances model on PhyloWiki's BioGeoBEARS updates page.
...
# load the saved result.
runslow = TRUE
resfn = "Linum_DEC_M0_constrained_w_v2.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
# For a slow analysis, run once, then set runslow=FALSE to just 
# load the saved result.
resfn = "Linum_DEC+J_M0_constrained_w_v2.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# PDF plots
#######################################################
pdffn = "Linum_DEC_vs_DEC+J_M0_constrained_w_v2.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Linum M0_constrained_v2"
...
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Linum M0_constrained_v2"
...
runslow = TRUE
resfn = "Linum_DIVALIKE_M0_constrained_w_v2.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Linum_DIVALIKE+J_M0_constrained_w_v2.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Linum_DIVALIKE_vs_DIVALIKE+J_M0_constrained_w_v2.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Linum M0_constrained_v2"
...
# Plot ancestral states - DIVALIKE+J
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Linum M0_constrained_v2"
...
geogfn = np("Linum_BGB_occurrence_mediterranean_bis.txt")
#extdata_dir = np(system.file("extdata", package="BioGeoBEARS"))
#extdata_dir
#list.files(extdata_dir)
#geogfn = np(paste(addslash(extdata_dir), "Psychotria_geog.data", sep=""))
...
-----Final analyses running - 05.02.2019
...
# load the saved result.
runslow = TRUE
resfn = "Linum_DEC_M0_unconstrained_mediterranean.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
# For a slow analysis, run once, then set runslow=FALSE to just 
# load the saved result.
resfn = "Linum_DEC+J_M0_unconstrained_mediterranean.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# PDF plots
#######################################################
pdffn = "Linum_DEC_vs_DEC+J_M0_unconstrained_mediterranean.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Linum M0_unconstrained_mediterranean"
...
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Linum M0_unconstrained_mediterranean"
...
runslow = TRUE
resfn = "Linum_DIVALIKE_M0_unconstrained_mediterranean.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Linum_DIVALIKE+J_M0_unconstrained_mediterranean.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Linum_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_mediterranean.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Linum M0_unconstrained_mediterranean"
...
# Plot ancestral states - DIVALIKE+J
#######################################################
analysis_titletxt ="Linum DIVALIKE+J on Linum M0_unconstrained_mediterranean"
...
BioGeoBEARS_run_object$dispersal_multipliers_fn = "Linum_BGB_manual_dispersal_multipliers_mediterranean.txt"
#BioGeoBEARS_run_object$areas_allowed_fn = "areas_allowed.txt"
#BioGeoBEARS_run_object$areas_adjacency_fn = areasadjacency
#BioGeoBEARS_run_object$distsfn = "distances_matrix.txt"
# See notes on the distances model on PhyloWiki's BioGeoBEARS updates page.
...
# load the saved result.
runslow = TRUE
resfn = "Linum_DEC_M0_constrained_w_mediterranean.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
# For a slow analysis, run once, then set runslow=FALSE to just 
# load the saved result.
resfn = "Linum_DEC+J_M0_constrained_w_mediterranean.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# PDF plots
#######################################################
pdffn = "Linum_DEC_vs_DEC+J_M0_constrained_w_mediterranean.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Linum M0_constrained_med"
...
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Linum M0_constrained_med"
...
runslow = TRUE
resfn = "Linum_DIVALIKE_M0_constrained_w_mediterranean.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Linum_DIVALIKE+J_M0_constrained_w_mediterranean.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Linum_DIVALIKE_vs_DIVALIKE+J_M0_constrained_w_mediterranean.pdf"
pdf(pdffn, width=7, height=9)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Linum M0_constrained_med"
...
# Plot ancestral states - DIVALIKE+J
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Linum M0_constrained_med"
